        ...
        <div  className={styles.restmainDiv}>
            <div className={styles.div}>
                <div style={{display: "flex", flexDirection: 'column'}}>
                    ...
                    <p className={styles.restText}>ჩვენი კომპანია გთავაზობთ ხარისხიან კომპიუტერულ ნაწილებს და ინოვაციურ ტექნოლოგიურ გადაწყვეტილებებს. ჩვენ ვმუშაობთ მხოლოდ ნდობით აღჭურვილ ბრენდებთან, რათა უზრუნველვყოთ თქვენი კომპიუტერის ხარისხი. სწრაფი მიწოდება და კმაყოფილი მომხმარებლები — ჩვენი მთავარი პრიორიტეტია!</p>
