            ...
            <div id="carousel" className={styles.Carousel}>
                <div className={`${styles.helperDiv}  ${visible ? styles.active : styles.exit}`} >
                    <div className={styles.CarouselDivFirst}>
                        ...
                        <p className={styles.CarouselText}>ააწყვეთ თქვენი კომპიუტერი უმაღლესი ხარისხის ნაწილებით! <br></br>სწრაფი მიწოდება, განახლება და პროფესიონალური სერვისი - ჩვენთან!</p>
